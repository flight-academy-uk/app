<script lang="ts">
    ...
    function toggleTheme() {
        const toggle_theme = document.documentElement.classList.toggle("dark");
        const theme = toggle_theme ? "dark" : "light";
...
<button 
    type="button" 
    class="flex gap-x-2 justify-center items-center w-full py-2 bg-secondary-600 hover:bg-secondary-700 rounded-lg text-white shadow-lg"
